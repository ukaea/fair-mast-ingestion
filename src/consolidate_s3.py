...
def download_shot(shot):
    ...
    download_command = [
        ...
        "cp", f"s3://mast/level1/shots/{shot}*", "/rds/project/rds-sPGbyCAPsJI/"
    ]
...
def process_shots(shot):
    ...
    if download_result.returncode == 0:
        ...
        consolidate(f"/rds/project/rds-sPGbyCAPsJI/{shot}.zarr")
        ...
        shutil.rmtree(f"/rds/project/rds-sPGbyCAPsJI/{shot}.zarr")
