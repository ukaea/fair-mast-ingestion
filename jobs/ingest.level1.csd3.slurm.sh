...
mpirun -n $num_workers \
    python3 -m src.level1.main --facility MAST --shot-min 11695 --shot-max 30474 -i abm act aga ahx ait alp amb amc ams anb ane anu arp asm atm ayc aye efm esm xbt xdc xim xmo xsx
